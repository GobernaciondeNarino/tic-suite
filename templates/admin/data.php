<?php
/**
 * Admin screen: raw data browser for a single view.
 *
 * @package TicSuite\Graficos
 * @var array  $views    View summaries.
...
<div class="wrap tsg-wrap">
	<header class="tsg-header">
		<div class="tsg-header__title">
			...
			<h1><?php esc_html_e( 'Datos de vista', 'tic-suite-graficos' ); ?></h1>
		</div>
	</header>

	<form method="get" class="tsg-form-inline">
		<input type="hidden" name="page" value="tic-suite-graficos-datos" />

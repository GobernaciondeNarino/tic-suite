...
class TSG_Chart_Types {
	...
	private function build_registry(): array {
		return [
			...
			'tree'        => [
				'label'        => __( 'Árbol', 'tic-suite-graficos' ),
				'icon'         => 'networking',
				'd3plus_class' => 'Tree',
				'categories'   => [ 'hierarchical', 'categorical', 'geographic' ],
				'requires'     => [ 'dimensions' => 1, 'measures' => 1 ],
				'description'  => __( 'Visualización jerárquica radial o vertical.', 'tic-suite-graficos' ),
			],
			'sankey'      => [
				'label'        => __( 'Sankey', 'tic-suite-graficos' ),
				'icon'         => 'randomize',
				'd3plus_class' => 'Sankey',
				'categories'   => [ 'network', 'hierarchical' ],
				'requires'     => [ 'dimensions' => 2, 'measures' => 1, 'edges' => true ],
				'description'  => __( 'Flujo de valores entre nodos.', 'tic-suite-graficos' ),
			],
			'rings'       => [
			...
			'box_whisker' => [
				'label'        => __( 'Caja y bigotes', 'tic-suite-graficos' ),
				'icon'         => 'chart-bar',
				'd3plus_class' => 'BoxWhisker',
				'categories'   => [ 'statistical', 'categorical', 'geographic' ],
				'requires'     => [ 'dimensions' => 1, 'measures' => 1 ],
				'description'  => __( 'Distribución estadística y outliers.', 'tic-suite-graficos' ),
			],
			'priestley'   => [
				...
				'categories'   => [ 'temporal' ],
				'requires'     => [ 'dimensions' => 1, 'measures' => 0, 'range' => true ],
				'description'  => __( 'Eventos con inicio y fin sobre una línea de tiempo.', 'tic-suite-graficos' ),
			],
		];
	}
